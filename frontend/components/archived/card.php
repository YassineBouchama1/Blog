<main id="container_list" class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 justify-center items-center min-h-[400px] w-full">
...
<script src="components/archived/builder.js"></script>