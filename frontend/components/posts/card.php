<main id="container_list" class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
  ...
  <article class="relative flex flex-col jusitfy-between gap-4 items-center min-h-[250px] h-auto  w-full bg-[#e5e5e5] dark:bg-[#252936] dark:text-white text-black transition-shadow rounded-[18px] shadow-md  backdrop-blur-md  ">
  ...
  <article class="relative flex flex-col jusitfy-between gap-4 items-center min-h-[250px] h-auto  w-full bg-[#e5e5e5] dark:bg-[#252936] dark:text-white text-black transition-shadow rounded-[18px] shadow-md  backdrop-blur-md  ">
    ...
    <div class="pb-4 pl-4	self-start	 text-md flex   items-center ">
      ...
      <img class="w-5 h-5" src="${IMG_BASE_URL}${item.image_author}">
      <a href="profile.php?action=userPosts&user_id=${item.user_id}"><span>Yassine</span></a>
      <i class="ti ti-discount-check-filled ml-1  text-[#1DA1F2] "></i>
