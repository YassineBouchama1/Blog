...
`).join('');
    ...
    card.classList = 'relative flex flex-col items-center min-h-[250px] h-auto  w-full bg-[#e5e5e5] dark:bg-[#252936] dark:text-white text-black rounded-[18px]   backdrop-blur-md ';
    card.innerHTML = `
