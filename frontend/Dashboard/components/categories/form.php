<div class="flex flex-col  items-center w-full text-xs px-4 py-8 gap-y-6">
    ...
    <div class=" w-full text-xs">
        ...
        <input name="name" id="name" placeholder="Company Name" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text">
    </div>
    <div class=" w-full text-xs">
